            ...
            <section className="outer-section-container">
                ...
                <div className={styles["home-inner-container"]}>
                    <section className={styles["welcome-section"]}>
                        ...
                        <h2 className={styles["main-welcome-subtitle"]}> Your Cocktail Companion For Every
                            Occasion!</h2>
                        <p className={styles["main-welcome-msg"]}>Discover the perfect cocktail for any event with our
                            Cocktail Finder, or let our Inspiration Quiz guide you to your next favorite sip. Get
                            started by choosing a button below! </p>
                    </section>
                    <div className={styles["button-container"]}>
                        <Button type="button" className="primary" onClick={() => navigate("/quiz")}>
                            QUIZ ME!
                        </Button>
                        <Button type="button" className={styles["findCocktailBtn"]}
